                ...
                <div class="col-sm-<?= $colwidth; ?>">
                    <div id="accordionfull-<?= $uid; ?>" role="tablist" aria-multiselectable="true">
                        <div class="card">
                            ...
                            <div id="collapseOnefull-<?= $uid; ?>" class="collapse show" role="tabpanel"
                ...
                <div class="col-sm-6">
                    <div id="accordionhalfy-<?= $uid; ?>" role="tablist" aria-multiselectable="true">
                        <div class="card">
                            ...
                            <div id="collapsehalfy-<?= $uid; ?>" class="collapse show" role="tabpanel"
                                 aria-labelledby="headingOne-<?= $uid; ?>">
                                <div class="card-block">
                                    <h1><?= $fullwidth; ?></h1>
                                    <?= $aonecontent; ?>
                ...
                <div class="col-sm-6">
                    <div id="accordiontwo-<?= $uid; ?>" role="tablist" aria-multiselectable="true">
                        <div class="card">
                            ...
                            <div id="collapsetwo-<?= $uid; ?>" class="collapse show" role="tabpanel"
